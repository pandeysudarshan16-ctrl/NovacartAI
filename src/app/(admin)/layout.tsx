...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-background text-foreground">
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="text-xs text-muted-foreground font-semibold">Verifying administrator authorization...</p>
        </div>
      </div>
    );
  }
  ...
  const navItems = [
    ...
    { name: "Sellers Registry", href: "/admin/sellers", icon: Users },
    { name: "Product Moderation", href: "/admin/products", icon: CheckSquare },
  ];
        ...
        <div className="flex h-16 items-center px-6 border-b border-white/5">
          <Link href="/" className="flex items-center gap-2">
            ...
            <span className="text-sm font-bold text-white tracking-wide">
              NovaCart<span className="text-primary">Admin</span>
            </span>
          </Link>
        </div>
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <header className="flex h-16 items-center justify-between px-6 border-b border-white/5 bg-card/50 backdrop-blur-md sticky top-0 z-40">
          ...
          <div className="flex items-center gap-3">
            <span className="text-[10px] font-bold bg-primary/20 text-primary border border-primary/30 px-2 py-0.5 rounded-full uppercase tracking-wider animate-pulse">
              System Admin
            </span>
          ...
          <aside className="w-64 bg-card p-6 flex flex-col justify-between border-r border-white/10">
            <div className="space-y-6">
              <div className="flex items-center justify-between gap-4">
                <Link href="/" className="flex items-center gap-2">
                  <span className="text-sm font-bold text-white">NovaCart<span className="text-primary">Admin</span></span>
                </Link>
                <button
